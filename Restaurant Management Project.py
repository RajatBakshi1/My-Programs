...
root.title("RMS by Rajat Bakshi")
...
f1.pack(side=LEFT,padx=250,pady=60)
...
project = Label(Tops, font=( 'aria' ,15 ),text="By Rajat Bakshi")
project.grid(row=2,column=0)
